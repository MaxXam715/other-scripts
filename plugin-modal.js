export default class Modal {
    ...
    constructor(data) {
        this.data = { // These are the defaults.
            ...
            mode: 'center', // center | top | right | full
            ...
            containerClassName:'', // class для контейнера
            eventCloseModal:'',
            footerEvents:{
                cancel: {
                    active: true,
    ...
    template() {
        ...
        if(this.data.containerClassName){
            modal.classList.add(this.data.containerClassName)
        }
